...
By contributing to this project, you agree that your contributions will be licensed under the same license as the project. See [LICENSE](https://github.com/microsoft/Agent365-python/blob/main/LICENSE.md) for more details.
